...
const PAGE_TAGS = {
    "header": {
        "menu": [
            document.querySelector(".menu__item:nth-child(1) .menu__link"),
            document.querySelector(".menu__item:nth-child(2) .menu__link"),
            document.querySelector(".menu__item:nth-child(3) .menu__link"),
            document.querySelector(".menu__item:nth-child(4) .menu__link")
        ]
    },
    "tile": [
            document.querySelector("#seriec .tile"),
            document.querySelector("#work .tile"),
            document.querySelector("#aboutus .tile"),
            document.querySelector("#review .tile")
    ],
};